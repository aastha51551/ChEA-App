              ...
              children: [
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: DisplayCard(
                        ...
                        title: 'Placement Resume Repository',
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: DisplayCard(
                        ...
                        title: 'Internship Resume Repository',
                        googleDriveLink: Uri.parse(
                ...
                Center(
                  child: SizedBox(
                    width: 400,
                    child: DisplayCard(
                        backgroundImage: 'assets/images/sch.jpg',
                        title: 'Schedule',
                        googleDriveLink: Uri.parse(
                            'https://drive.google.com/drive/folders/1FgCqINEDVJWPzo0njxsV8tFPQix7t1Ck')),
                  ),
                ),
                const SizedBox(height: 20),
                Center(
                  child: SizedBox(
                    width: 400,
                    child: DisplayCard(
                        backgroundImage: 'assets/images/form.png',
                        title: 'Forms',
                        googleDriveLink:
                            Uri.parse('https://cheaiitb.in/form.html')),
                  ),
                ),
                const SizedBox(height: 20),
              ],
